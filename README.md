...
boundary conditions and human validation: Galindez 2026, preprints 1–3). `rdim` makes every
...
independent halves of your trials* — the response's reproducible dimensionality. In 364
